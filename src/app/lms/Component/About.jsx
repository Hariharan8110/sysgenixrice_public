...
import { IoMdCall, IoMdArrowForward } from "react-icons/io";
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          <div className="w-full lg:w-1/2 space-y-6" data-aos="fade-left">
            ...
            <blockquote className="text-lg italic text-gray-600 pl-6 border-l-4 border-blue-500">
              "We deliver innovative, scalable technology solutions that drive
              measurable business success."
            </blockquote>

            <p className="text-gray-700 leading-relaxed">
              Sysgenixrise specializes in cutting-edge digital transformation
              services, from cloud-native architectures to AI-powered
              automation. Our mission is to revolutionize industries through
              innovation, providing seamless technology integrations that
              enhance efficiency, security, and growth for businesses worldwide.
            </p>
