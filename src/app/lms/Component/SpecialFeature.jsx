...
const features = [
  ...
  },
  {
    ...
    description: "Leverage cutting-edge AI for business transformation",
  },
  {
    icon: <FaShieldAlt className="text-4xl" />,
    title: "Enterprise-Grade Security",
    description: "Military-grade protection for your critical data",
  },
  {
    icon: <FaCloud className="text-4xl" />,
    title: "Seamless Cloud Integration",
    description: "Hybrid cloud solutions tailored to your needs",
  },
  {
