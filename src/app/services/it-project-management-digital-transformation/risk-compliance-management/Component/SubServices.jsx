...
export default function SubServicesRisk() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Risk & Compliance Management     </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Mitigating Risks while Enhancing Operational Efficiency          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          We help businesses establish robust IT governance frameworks to manage risks, ensure compliance, and maximize the value of technology investments. Our services cover everything from security assessments to compliance audits.          </p>
