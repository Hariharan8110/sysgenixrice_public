...
export default function SubServicesProject() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          IT Project Management & Digital Transformation                    </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Transforming Your Business for the Digital Age
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          At SysGenixRise IT Solutions, we offer comprehensive IT Project Management and Digital Transformation services, helping businesses optimize processes, adopt new technologies, and achieve strategic goals. Our end-to-end solutions ensure that each phase of your transformation journey—from planning to implementation—is executed with precision and aligned with your unique business needs.          </p>
