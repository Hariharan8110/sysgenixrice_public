    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysgenixRise IT Solutions, we specialize in IT project management and digital transformation to help businesses streamline operations, adopt cutting-edge technologies, and drive sustainable growth. Our expert-led solutions ensure seamless project execution, agile methodologies, and successful technology adoption.
          </p>
