...
export default function SubServicesEnd() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          End TO End IT Implementation         </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Empowering Businesses with Innovative Solutions          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Our Digital Transformation Strategy service helps businesses integrate cutting-edge technologies, optimize workflows, and transform customer experiences. We guide you through the entire transformation journey to ensure long-term success.          </p>
