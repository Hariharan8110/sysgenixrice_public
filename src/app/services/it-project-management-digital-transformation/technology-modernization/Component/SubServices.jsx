...
export default function SubServicesTechnology() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Technology Modernization        </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Ensuring Long-Term Success After Transformation          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Our job doesn’t stop at implementation. We offer comprehensive post-implementation support and optimization services to ensure that your systems continue to operate at peak performance and deliver ongoing value to your business.          </p>
