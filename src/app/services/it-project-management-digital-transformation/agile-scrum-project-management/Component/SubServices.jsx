...
export default function SubServicesAgile() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
         ...
         Agile & Scrum Project Management         </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Adapting Quickly to Changing Needs with Agile Methodologies          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          We adopt Agile project management techniques to offer flexibility and rapid response to changing business needs. With Agile, your business can adjust to market demands quickly while maintaining quality and delivering projects faster.   </p>
