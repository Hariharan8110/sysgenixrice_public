  ...
  const cardData = [
    {
      ...
      name: "Agile Framework Implementation",
      descriptions:
        "Empower teams with Agile methodologies to enhance project efficiency and adaptability.",
    },
    {
      id: "02",
      icon: <FaUserCheck className="text-4xl text-secondaryColor" />,
      name: "Scrum Master & Coaching",
      descriptions:
        "Certified Scrum Masters to guide teams in iterative development and continuous improvement.",
    },
    {
      id: "03",
      ...
      descriptions:
        "Facilitate structured sprint planning, execution, and retrospective meetings for seamless delivery.",
    },
    {
      id: "04",
      ...
      descriptions:
        "Optimize backlog refinement, prioritization, and user story mapping for successful product development.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Enhance Agile workflows with CI/CD pipelines for faster and more reliable product releases.",
    },
    {
      id: "06",
      icon: <GoGraph className="text-4xl text-secondaryColor" />,
      name: "Agile Metrics & Performance Tracking",
      descriptions:
        "Track project progress with Agile KPIs like velocity, burndown charts, and cycle time analysis.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for Agile & Scrum Project Management?
        </h1>
