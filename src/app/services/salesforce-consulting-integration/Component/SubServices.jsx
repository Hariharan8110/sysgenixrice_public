...
export default function SubServicesSaleForce() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          At SysgenixRise IT Solutions, we specialize in Salesforce consulting, implementation, and integration to help businesses enhance customer engagement, optimize sales processes, and improve operational efficiency. Whether you need a new Salesforce implementation, custom automation, or seamless integration, we ensure a tailored solution that aligns with your business needs.          </p>
