    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Integrating Salesforce with third-party applications improves data consistency, eliminates silos, and enhances business performance. We offer seamless integration services with ERP, marketing automation, e-commerce, and other enterprise platforms.          </p>
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                "Salesforce & ERP System Integration (SAP, Oracle, NetSuite)",
                "Marketing Automation (HubSpot, Marketo, Mailchimp)",
                "E-commerce Integration (Shopify, Magento, WooCommerce)",
                "Accounting & Billing System Integration (QuickBooks, Xero)",
