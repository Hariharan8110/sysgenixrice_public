  ...
  const cardData = [
    {
      ...
      descriptions:
        "Connect external applications with your system effortlessly using secure APIs.",
    },
    {
      id: "02",
      ...
      descriptions:
        "Integrate Salesforce, HubSpot, SAP, and other tools for streamlined operations.",
    },
    {
      id: "03",
      ...
      descriptions:
        "Enable secure transactions by integrating Stripe, PayPal, and other payment services.",
    },
    {
      id: "04",
      ...
      descriptions:
        "Integrate Shopify, WooCommerce, and Amazon to manage sales and inventory.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Sync with Google Drive, Dropbox, and OneDrive for seamless file access.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Integrate Mailchimp, Zapier, and Google Analytics to enhance marketing efforts.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for Third Party Integration?
