  ...
  const cardData = [
    {
      ...
      descriptions:
        "Get real-time insights with visually appealing and dynamic dashboards.",
    },
    {
      id: "02",
      ...
      descriptions:
        "Generate detailed reports tailored to your business needs with custom filters and metrics.",
    },
    {
      id: "03",
      ...
      descriptions:
        "Monitor key business metrics and track performance indicators efficiently.",
    },
    {
      id: "04",
      ...
      descriptions:
        "Consolidate data from multiple sources like CRM, ERP, and databases into one dashboard.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Use graphs, charts, and heatmaps to make data-driven decisions quickly.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Schedule and automate report generation to keep stakeholders informed.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for Custom Dashboards Reports
        </h1>
