    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          We create custom Salesforce dashboards and reports to give businesses actionable insights into sales, marketing, and customer engagement metrics.          </p>
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                "Custom Sales & Revenue Forecasting Dashboards",
                "Lead Performance & Marketing Analytics Reports",
                "Customer Engagement & Retention Metrics",
                "AI-Powered Predictive Analytics for Sales",
                "Real-Time KPI",
