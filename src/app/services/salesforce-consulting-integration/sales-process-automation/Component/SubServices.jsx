...
export default function SubServicesSales() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Automate & Optimize Your Sales Cycle
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Automation is key to improving efficiency and accelerating sales. We help businesses automate repetitive tasks, enhance lead management, and optimize the sales pipeline with Salesforce’s automation tools.
          </p>
