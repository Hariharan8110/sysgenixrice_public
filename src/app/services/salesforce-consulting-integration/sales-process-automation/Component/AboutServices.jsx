    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Streamline operations and reduce human errors with AI-powered automation. From workflow automation and robotic process automation (RPA) to AI-driven decision-making, intelligent solutions enhance productivity and operational efficiency. By automating repetitive processes, businesses can accelerate sales cycles, optimize resource utilization, and drive growth.          </p>
