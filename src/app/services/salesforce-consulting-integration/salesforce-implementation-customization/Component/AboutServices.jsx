    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          A successful Salesforce implementation requires expert customization and optimization. We ensure that your Salesforce CRM is fully configured to match your workflows, improving productivity and customer relationship management.          </p>
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                "End-to-End Salesforce CRM Deployment",
                "Custom Objects, Workflows & Process Automation",
                "User Training",
                "Adoption Strategies",
                "Salesforce Migration from Legacy Systems",
