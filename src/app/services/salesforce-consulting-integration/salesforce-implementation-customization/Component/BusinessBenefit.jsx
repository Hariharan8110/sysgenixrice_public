...
const BusinessSalesF = () => {
  const benefits = [
    "Increase productivity by reducing manual tasks",
    "Improve lead conversion rates with smart automation",
    "Ensure consistent communication with automated follow-ups"
  ];
