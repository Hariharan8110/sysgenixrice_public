    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysGenixRise IT Solutions, we provide a comprehensive range of cloud services to help businesses optimize their digital infrastructure. From cloud migration and deployment to security and maintenance, our solutions ensure scalability, reliability, and cost efficiency. Whether you're adopting a hybrid, public, or private cloud, we tailor our services to meet your unique business needs, enabling seamless integration and enhanced performance in a rapidly evolving digital environment.          </p>
