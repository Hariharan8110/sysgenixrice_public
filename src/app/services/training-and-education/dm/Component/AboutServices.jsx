      ...
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          <p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
            At SysGenixRise IT Solutions, we offer a full spectrum of digital
            marketing services to help businesses grow their online presence and
            drive measurable results. From SEO and social media management to
            PPC advertising and content marketing, our strategies are crafted to
            boost visibility, attract the right audience, and increase
            conversions. Whether you're a startup or an established brand, we
            tailor our solutions to your goals—ensuring sustained growth in a
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
  "SEO & Keyword Strategy Training",
  "Social Media Marketing Workshops",
  "Content Creation & Copywriting Training",
  "Google Ads & PPC Campaign Training",
