...
export default function SubServicesDm() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <h3 className="text-white font-bold uppercase mb-8">DM</h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
            Unlock the Power of Digital Marketing with Expert Strategies
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
            At SysGenixRise IT Solutions, we offer result-driven digital
            marketing services to boost your online presence, drive targeted
            traffic, and increase conversions. From SEO and social media
            marketing to content creation and paid advertising, our strategies
            are tailored to meet your business goals. Stay ahead in the
            competitive digital landscape with our expert team ensuring
            visibility, engagement, and growth across all major platforms.
          </p>
