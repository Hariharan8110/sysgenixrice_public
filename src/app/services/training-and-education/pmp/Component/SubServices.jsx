...
export default function SubServicesPmp() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Predictive Model Processing        </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Unlock Business Insights from Text & Speech Data
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Predictive Model Processing empowers businesses to make data-driven decisions by analyzing historical data and identifying patterns. Using advanced AI and machine learning algorithms, we help organizations forecast trends, optimize operations, and enhance customer experiences. From demand prediction to risk assessment, our solutions enable smarter decision-making and improved efficiency across various industries.
          </p>
