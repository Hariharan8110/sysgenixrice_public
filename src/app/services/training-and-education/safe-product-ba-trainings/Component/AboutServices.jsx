    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Safe Product BA Training 
          </h1>
          <p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
          Our SAFe Business Analysis (BA) training equips professionals with the skills needed to analyze business needs, optimize workflows, and drive Agile product development. We focus on key areas such as requirement gathering, backlog management, stakeholder collaboration, and SAFe principles to enhance product success.
          </p>
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                "Equip your employees with essential AI skills",
