...
const BusinessSafe = () => {
  const benefits = [
    "Improve efficiency and knowledge across your team",
    "Equip employees with the skills needed to perform better and faster",
    "Stay up-to-date with continuous learning, particularly in AI and software testing, keeping your team at the cutting edge"
  ];
