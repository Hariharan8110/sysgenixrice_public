...
<p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
  At SysGenixRise IT Solutions, we offer end-to-end Full Stack Development services to build robust, scalable, and high-performance web and mobile applications. From frontend design and backend development to database integration and API management, our solutions are tailored to meet your business goals. Whether you're launching a startup or scaling an enterprise application, we deliver seamless integration, modern tech stacks, and efficient deployment to help you thrive in today’s digital landscape.
</p>
  ...
  "RESTful API & Microservices Training",
  "Version Control with Git & GitHub",
  "Full Stack Project Architecture & Deployment"
]
.map((service, index) => (
                <div
                  key={index}
