...
export default function SubServicesFsd() {
...
<h1 className="text-4xl font-bold mt-2 text-white font-title">
  Unlock the Power of Full Stack Development with Expert Solutions
</h1>
<p className="mt-4 text-gray-200 text-lg">
  At SysGenixRise IT Solutions, we provide cutting-edge full stack development services designed to accelerate your digital transformation, ensure seamless user experiences, and build scalable applications. From front-end development and backend integration to database management and deployment, our tailored solutions empower businesses to leverage the complete power of modern web technologies. Stay competitive in the tech-driven world with our expert FSD services, ensuring agility, performance, and end-to-end development excellence.
</p>
