    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Scrum empowers businesses to streamline project management, improve collaboration, and enhance team efficiency. By adopting Agile principles, organizations can rapidly adapt to changing requirements, deliver high-quality products, and optimize workflow processes. From sprint planning and daily stand-ups to backlog management and continuous improvement, our Scrum services help teams achieve their goals with agility and precision.
          </p>
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                ...
                "Automated Text Summarization & Translation",
                "AI-Driven Document Analysis & Processing ",
