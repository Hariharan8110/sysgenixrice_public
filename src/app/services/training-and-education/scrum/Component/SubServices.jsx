...
export default function SubServicesScrum() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Optimize Agile Workflows with Scrum
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Scrum is a powerful Agile framework that enables teams to collaborate effectively, adapt to changes, and deliver high-quality results efficiently. By implementing Scrum methodologies, businesses can streamline project management, enhance team productivity, and foster continuous improvement. From sprint planning to daily stand-ups, we help organizations leverage Scrum to drive innovation, improve workflow efficiency, and achieve their project goals with agility.
          </p>
