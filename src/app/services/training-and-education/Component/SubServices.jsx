...
export default function SubServicesTraining() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Empower Your Workforce with Cutting-Edge Training Programs
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          At SysGenixRise IT Solutions, we offer a variety of training programs tailored to equip your team with the latest skills and technologies, from AI to software testing. Our training solutions are designed to increase your team's productivity, enhance their knowledge, and ensure they stay ahead in a competitive digital landscape.          </p>
