  ...
  const cardData = [
    {
      ...
      descriptions:
        "Hands-on learning experiences designed to upskill professionals.",
    },
    {
      id: "02",
      icon: <FaUserCheck className="text-4xl text-secondaryColor" />,
      name: "Industry-Relevant Courses",
      descriptions:
        "Stay ahead with courses aligned to market trends and demands.",
    },
    {
      id: "03",
    ...
    },
    {
      ...
      descriptions:
        "Choose from online, in-person, or hybrid learning models.",
    },
    {
      id: "05",
      icon: <FaSearch className="text-4xl text-primarycolor" />,
      name: "Certifications & Skill Enhancement",
      descriptions:
        "Gain industry-recognized certifications to boost your career.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Customized training programs for organizations to enhance workforce skills.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for Training And Education?        </h1>
