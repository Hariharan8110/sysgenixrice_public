    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysgenixRise IT Solutions, we provide comprehensive training programs designed to equip professionals with cutting-edge skills in technology and business. Our tailored educational solutions cover a range of disciplines, including Artificial Intelligence (AI), Machine Learning (ML), Cloud Computing, Agile Methodologies, and Business Analysis.
          </p>
