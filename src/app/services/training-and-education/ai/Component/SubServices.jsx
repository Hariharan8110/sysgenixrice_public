...
export default function SubServicesAiTraining() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          AI empowers businesses to automate processes, enhance decision-making, and drive innovation. From machine learning models to intelligent automation, we help businesses leverage AI to optimize operations, improve customer experiences, and unlock valuable insights from data.
          </p>
