    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          NLP enables businesses to analyze and interpret human language to enhance customer interactions and gain valuable insights. From sentiment analysis to AI-powered chatbots, we help businesses leverage NLP for automation, communication, and data analysis.
          </p>
...
export default AboutAiTraining;
