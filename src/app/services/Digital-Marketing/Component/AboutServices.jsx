...
const AboutAiData = () => {
  ...
  <p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
    At SysgenixRise IT Solutions, our Digital Marketing services are designed to amplify your brand’s online presence. We specialize in SEO, content marketing, social media strategies, paid ads, and email campaigns—empowering businesses to connect with the right audience, drive traffic, and achieve measurable growth. Our data-driven approach ensures maximum ROI and continuous optimization.
  </p>
