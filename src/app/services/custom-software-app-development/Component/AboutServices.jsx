    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysgenixRise IT Solutions, we build innovative, scalable, and high-performance software solutions tailored to business needs. From enterprise applications to mobile apps, our cutting-edge development strategies enhance automation, efficiency, and user engagement. Leveraging AI, predictive analytics, and advanced technologies, our custom solutions drive digital transformation and long-term business growth.
          </p>
