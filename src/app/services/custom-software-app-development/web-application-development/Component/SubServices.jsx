...
export default function SubServicesWeb() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Build Powerful, Scalable & Secure Web Solutions
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          We develop custom web applications tailored to your business needs. Our web development process ensures that your application is fast, secure, and responsive, offering a seamless experience across all devices.          </p>
