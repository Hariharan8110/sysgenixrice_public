...
export default function SubServicesMobile() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Create High-Performance Mobile Apps for iOS & Android
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          We design and develop mobile applications that offer smooth, intuitive, and engaging user experiences. Whether it's a native, hybrid, or cross-platform app, our development approach ensures that your business reaches the right audience effectively.          </p>
