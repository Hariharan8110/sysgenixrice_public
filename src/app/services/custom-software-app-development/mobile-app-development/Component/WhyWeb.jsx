  ...
  const cardData = [
    {
      ...
      descriptions:
        "Build high-performance mobile apps tailored to your business needs.",
    },
    {
      id: "02",
      ...
      descriptions:
        "Seamless mobile experiences across iOS and Android platforms.",
    },
    {
      id: "03",
      icon: <FaTrafficLight className="text-4xl text-primarycolor" />,
      name: "Native & Hybrid Apps",
      descriptions:
        "Leverage the best of both worlds with native and hybrid mobile solutions.",
    },
    {
      id: "04",
      ...
      descriptions:
        "Intuitive and visually engaging mobile interfaces for user satisfaction.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Boost visibility and downloads with ASO strategies for app stores.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Future-proof mobile applications with high security and scalability.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for Mobile Application Development ?
        </h1>
