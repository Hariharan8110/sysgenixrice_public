...
export default function SubServicesUI() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Create Visually Appealing & User-Centric Designs
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          A well-designed interface can make a significant difference in user experience, engagement, and conversion rates. We create modern, intuitive, and accessible designs for web and mobile applications.          </p>
