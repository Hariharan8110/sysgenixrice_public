...
export default function SubServicesECommerce() {
...
<h1 className="text-4xl font-bold mt-2 text-white font-title">
  Empower Your Online Store with Scalable & Secure E-Commerce Solutions
</h1>
<p className="mt-4 text-gray-200 text-lg">
  We build high-performance e-commerce platforms that ensure seamless shopping experiences, secure transactions, and effortless integration with your business operations.
</p>
