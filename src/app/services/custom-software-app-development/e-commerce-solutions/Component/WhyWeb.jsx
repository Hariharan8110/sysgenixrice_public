  ...
  const cardData = [
    {
      ...
      descriptions:
        "Build high-performance online stores tailored to your business needs.",
    },
    {
      id: "02",
      ...
      descriptions:
        "Secure and diverse payment gateways for smooth transactions.",
    },
    {
      id: "03",
      ...
      descriptions:
        "Enable multiple sellers on a single platform with ease.",
    },
    {
      id: "04",
      icon: <FaMobileAlt className="text-4xl text-secondaryColor" />,
      name: "Mobile-Friendly E-Commerce",
      descriptions:
        "Responsive designs for seamless shopping on any device.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Enhance search rankings and boost organic traffic to your store.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Track sales and customer behavior to improve conversions.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for E-Commerce-Solutions?
        </h1>
...
export default WhyWebECommerce;
