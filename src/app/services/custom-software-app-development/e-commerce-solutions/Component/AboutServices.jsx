    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysgenixRise IT Solutions, we develop enterprise-grade e-commerce solutions that seamlessly integrate with existing IT infrastructure. Our scalable and secure platforms enhance productivity, streamline operations, and improve customer experiences, enabling businesses to thrive in the digital marketplace.         </p>
