...
const BusinessBenefitsPredictive = () => {
  const benefits = [
    "Enhance decision-making with accurate forecasts",
    "Identify business risks before they happen",
    "Improve customer engagement with targeted strategies"
  ];
...
export default BusinessBenefitsPredictive;