    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Predictive analytics enables businesses to forecast trends, anticipate customer needs, and make data-driven decisions. Our AI-powered predictive models use historical data, advanced algorithms, and real-time insights to improve efficiency and profitability.
          </p>
...
export default AboutPredictive;
