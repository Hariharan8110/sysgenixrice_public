...
export default function SubServicesPredictive() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Predictive analytics enables businesses to forecast trends, anticipate customer needs, and make data-driven decisions. Our AI-powered predictive models use historical data, advanced algorithms, and real-time insights to improve efficiency and profitability.          </p>
