    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysgenixRise IT Solutions, we leverage cutting-edge AI and Machine Learning (ML) to transform data into actionable insights. Our AI-driven solutions optimize operations, enhance decision-making, and boost efficiency. From automation and predictive analytics to NLP and generative AI, we empower businesses to stay competitive, reduce costs, and improve customer experiences.
          </p>
