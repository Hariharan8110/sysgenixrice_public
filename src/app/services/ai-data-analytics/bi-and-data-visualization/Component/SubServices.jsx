...
export default function SubServicesBiData() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Innovate with AI-Driven Content & Automation
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Innovate with AI-Driven Content & Automation
          Generative AI is revolutionizing industries by creating high-quality content, automating software development, and enabling businesses to personalize customer experiences. We implement state-of-the-art AI models to automate creative tasks, generate business content, and improve decision-making.
          </p>
