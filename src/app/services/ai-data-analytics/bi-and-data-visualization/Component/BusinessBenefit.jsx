...
const BusinessBenefitsBi = () => {
  const benefits = [
    "Automate content creation for marketing & business communications",
    "Improve productivity with AI-driven automation tools",
    "Enhance customer experiences with personalized AI recommendations"
  ];
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2 flex justify-center mt-6 lg:mt-0">
          <img 
            ...
            className="w-full max-w-md lg:max-w-full h-auto rounded-lg shadow-md"
            loading="lazy"
          />
        </div>
      </div>
...
export default BusinessBenefitsBi;