    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          At SysgenixRise IT Solutions, we help businesses maximize the power of Salesforce through seamless integration and tailored consulting services. Our AI-powered solutions enhance customer relationship management (CRM), automate workflows, and optimize sales processes. From data-driven insights to custom automation, we ensure businesses leverage Salesforce to improve efficiency, boost customer engagement, and drive revenue growth.         </p>
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                "AI-Generated Content (Blogs, Emails, Reports)",
