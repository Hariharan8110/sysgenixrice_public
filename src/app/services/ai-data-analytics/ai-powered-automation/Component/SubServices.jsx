...
export default function SubServicesAiPowered() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Revolutionizing Business Efficiency with Intelligent Automation
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          AI-powered automation eliminates manual processes, streamlining operations and reducing human errors. Whether it’s workflow automation, robotic process automation (RPA), or AI-driven decision-making, we help businesses enhance productivity and operational efficiency.
          </p>
