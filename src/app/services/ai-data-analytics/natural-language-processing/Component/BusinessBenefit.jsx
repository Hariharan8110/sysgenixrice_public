...
const BusinessBenefitsNatural = () => {
  const benefits = [
    "Enhance customer experience with AI-driven interactions",
    "Automate text-based processes for improved efficiency",
    "Gain deep insights from unstructured data"
  ];
...
export default BusinessBenefitsNatural;