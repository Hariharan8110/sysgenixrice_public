    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Seamless cloud migration services ensure efficient transitions with minimal downtime. End-to-end strategies enhance scalability, security, and performance while optimizing workloads for cost-effective cloud infrastructure. Advanced methodologies ensure reliability, flexibility, and long-term success in the cloud ecosystem.          </p>
