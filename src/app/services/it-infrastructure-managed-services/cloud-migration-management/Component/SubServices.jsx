...
export default function SubServicesCloud() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Ensure Software Excellence with Comprehensive Testing Solutions
          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          At SysgenixRise IT Solutions, we provide end-to-end Software Testing Services to ensure your applications function flawlessly. Our testing strategies enhance software reliability, security, and performance.       </p>
