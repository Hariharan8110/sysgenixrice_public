    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Ensure a seamless transition to the cloud with end-to-end migration solutions. From strategy planning to execution, cloud migration services enhance scalability, security, and performance. Advanced methodologies minimize downtime, optimize workloads, and ensure a cost-effective cloud infrastructure for long-term success.          </p>
