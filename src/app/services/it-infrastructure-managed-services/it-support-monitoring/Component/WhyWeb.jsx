  ...
  const cardData = [
    {
      ...
      name: "Round-the-Clock IT Support",
      descriptions:
        "24/7 technical assistance to resolve IT issues and ensure business continuity.",
    },
    {
      id: "02",
      ...
      descriptions:
        "Continuous monitoring to detect and fix issues before they impact operations.",
    },
    {
      id: "03",
      icon: <FaTrafficLight className="text-4xl text-primarycolor" />,
      name: "Network & Server Health Checks",
      descriptions:
        "Regular assessments to optimize system performance and prevent failures.",
    },
    {
      id: "04",
      ...
      descriptions:
        "Advanced security measures to safeguard data and prevent cyberattacks.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Rapid response to IT incidents, minimizing downtime and disruptions.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Continuous tuning of IT systems for maximum efficiency and speed.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for 24/7 IT Support & Monitoring? 
        </h1>
