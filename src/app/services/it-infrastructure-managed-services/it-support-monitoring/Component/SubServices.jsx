...
export default function SubServicesSupport() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          24/7 IT Support & Monitoring     </h3>
          <h1 className="text-4xl font-bold mt-2 text-white font-title">
          Cloud Solutions          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Leverage cloud technology to enhance flexibility, security, and efficiency. Our cloud services help businesses transition from on-premise infrastructure to scalable cloud environments.
          </p>
