    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Ensure uninterrupted operations with round-the-clock IT support and proactive monitoring. Advanced solutions detect and resolve issues in real-time, minimizing downtime and enhancing system reliability. With continuous performance tracking and security management, businesses can maintain seamless operations and optimal IT efficiency.       </p>
