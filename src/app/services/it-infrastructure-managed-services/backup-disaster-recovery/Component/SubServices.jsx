...
export default function SubServicesBackUp() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Data Backup & Disaster Recovery          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Ensure business continuity with reliable data backup and disaster recovery solutions. Our services protect your critical business information from accidental loss, cyberattacks, and system failures          </p>
