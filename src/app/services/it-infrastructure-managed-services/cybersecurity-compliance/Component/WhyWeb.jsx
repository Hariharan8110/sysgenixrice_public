  ...
  const cardData = [
    {
      ...
      descriptions:
        "Ensure your business meets industry security standards and compliance requirements.",
    },
    {
      id: "02",
      ...
      descriptions:
        "Identify security vulnerabilities and implement proactive risk management strategies.",
    },
    {
      id: "03",
      ...
      descriptions:
        "Safeguard sensitive business data with advanced encryption and privacy measures.",
    },
    {
      id: "04",
      ...
      descriptions:
        "Monitor and respond to cyber threats in real-time to prevent data breaches.",
    },
    {
      id: "05",
      ...
      descriptions:
        "Empower employees with knowledge to recognize and prevent cybersecurity threats.",
    },
    {
      id: "06",
      ...
      descriptions:
        "Automated compliance tracking to keep your organization aligned with regulations.",
    },
  ];
  ...
  return (
    <div className="bg-yellow-50 w-full  py-16">
      <div className="flex flex-col md:px-20 px-8 items-center justify-center w-full  text-center ">
        ...
        Why Choose SysgenixRise IT Solutions for Cybersecurity Compliance?
        </h1>
