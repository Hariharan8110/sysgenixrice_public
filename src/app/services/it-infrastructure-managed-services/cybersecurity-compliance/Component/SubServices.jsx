...
export default function SubServicesCyber() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Protect your IT infrastructure with robust cybersecurity solutions. We provide end-to-end security management to prevent cyber threats, data breaches, and system vulnerabilities.          </p>
