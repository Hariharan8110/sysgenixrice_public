    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          Ensure software reliability, security, and performance with comprehensive testing solutions. From functional and performance testing to security and automation, managed testing services optimize application quality while reducing risks and downtime. Scalable testing frameworks enhance efficiency, ensuring seamless user experiences and robust software performance.  </p>
