...
export default function SubServicesManaged() {
...
<p className="mt-4 text-gray-200 text-lg">
  Deliver high-performance applications with end-to-end testing solutions. Our managed testing services enhance software reliability, security, and efficiency, ensuring seamless functionality across all platforms.
</p>
