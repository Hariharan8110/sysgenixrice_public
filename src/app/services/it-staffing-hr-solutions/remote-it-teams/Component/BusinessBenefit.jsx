...
const BusinessRemote = () => {
  const benefits = [
    "Agility to respond to immediate project needs",
    "Cost-effective staffing without compromising on quality",
    "Access to a diverse pool of IT specialists"
  ];
