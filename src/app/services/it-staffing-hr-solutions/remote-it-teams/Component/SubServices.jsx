...
export default function SubServicesRemote() {
    ...
    <>
      ...
      <section className="relative bg-gray-100 py-24 h-fit px-6 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
        ...
        >
          ...
          Flexible Workforce Solutions to Meet Project Demands          </h1>
          <p className="mt-4 text-gray-200 text-lg">
          Adapt to fluctuating workloads and project requirements with our Contract IT Staffing services. We provide experienced IT professionals on a temporary basis, allowing you to scale your workforce as needed without the long-term commitment.          </p>
