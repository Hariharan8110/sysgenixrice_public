    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          In today’s digital landscape, businesses need reliable, scalable, and cost-effective IT solutions to stay competitive. Remote IT Teams offer businesses access to a highly skilled workforce without the limitations of geographical boundaries. Whether you need dedicated developers, cybersecurity experts, or round-the-clock IT support, our remote teams ensure seamless IT operations tailored to your business needs. </p>          <div className="w-full">
