...
<h1 className="text-4xl font-bold mt-2 text-white font-title">
  Empower Your Workforce with Cutting-Edge IT Skills
</h1>
<p className="mt-4 text-gray-200 text-lg">
  Stay ahead in the digital era with our IT Training & Skill Development programs. We offer hands-on training in the latest technologies, ensuring your team gains the expertise needed to drive innovation and efficiency in your organization.
</p>
