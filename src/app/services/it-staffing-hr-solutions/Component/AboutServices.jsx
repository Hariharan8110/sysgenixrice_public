    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          IT Staffing HR Solutions          </h1>
          <p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
          IT Staffing HR Solutions involve providing businesses with skilled IT professionals, either on a temporary, contract, or permanent basis. These services help companies scale their workforce efficiently, reduce hiring time, and access top-tier talent without the complexities of direct recruitment. </p>          
