...
HR Process Outsourcing          </h1>
          <p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
          HR Process Outsourcing (HRO) is a strategic approach where businesses delegate their human resources functions to an external service provider. This allows organizations to focus on their core business activities while ensuring efficient and cost-effective HR management.</p>          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-medium md:gap-6 gap-2 py-2 md:py-0">
              {[
                "C-Level Recruitment",
                "Confidential Searches",
                "Market Mapping & Talent Pipelining",
