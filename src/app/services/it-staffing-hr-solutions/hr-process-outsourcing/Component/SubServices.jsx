...
export default function SubServicesHr() {
...
<h1 className="text-4xl font-bold mt-2 text-white font-title">
          Enhancing Efficiency Through Outsourced HR Solutions
</h1>
<p className="mt-4 text-gray-200 text-lg">
          Streamline your HR operations with our comprehensive outsourcing services. From talent acquisition and payroll management to compliance and employee engagement, we help businesses reduce administrative burdens and improve workforce productivity.
</p>
