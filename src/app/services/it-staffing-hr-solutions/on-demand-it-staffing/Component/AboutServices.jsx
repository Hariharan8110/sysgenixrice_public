    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center px-4 py-6 md:px-6 md:py-8 lg:px-20 space-y-8 md:space-y-0">
        ...
        <div className="lg:w-1/2" data-aos="fade-up">
          ...
          On-Demand IT Staffing        </h1>
          <p className="text-gray-800 md:text-base tracking-wider text-justify font-medium md:py-5 py-2">
          On-Demand IT Staffing is a flexible hiring solution that allows businesses to quickly scale their IT workforce based on project needs, seasonal demands, or skill gaps. This model helps companies access skilled IT professionals without the long-term commitment of full-time hires. </p>          <div className="w-full">
