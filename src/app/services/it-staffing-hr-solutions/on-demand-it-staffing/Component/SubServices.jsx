...
export default function SubServicesDemand() {
...
<h1 className="text-4xl font-bold mt-2 text-white font-title">
  Scale Your IT Team Instantly with Expert Talent
</h1>
<p className="mt-4 text-gray-200 text-lg">
  Quickly access highly skilled IT professionals to meet your project demands. Our On-Demand IT Staffing service connects you with top-tier tech talent, ensuring flexibility, efficiency, and seamless integration into your team.
</p>
